...
console.log('The results is in the objects are', myObj['results']);
...
function populate() {
	...
	results.forEach(element => {
		html += `<li class="list-group-item list-group-item-light">One of the definitions of the word 'example' is ${element.definition}</li>`;
	});
