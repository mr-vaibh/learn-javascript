console.log('ES6 version of main.js');
...
class Display {
	...
	// Creating a clear form method
	clear() {
		let libraryForm = document.getElementById('libraryForm');
		libraryForm.reset();
	}

	// Creating a validate form method
	validate(book) {
	...
	// Creating a show alert method
	show(alrtType, msgType, message) {
